...
This project is a simple BMI (Body Mass Index) calculator app built using Flutter.
The app allows users to calculate their BMI based on their height and weight and provides a corresponding BMI category.
...
command:
git clone https://github.com/sajadflutter/bmi_calculator.git
